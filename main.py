...
def calculate_score(cards):
  ...
  while game_play:
    ...
    print('The users total sum is',sum(user))
    print('The computers sum is', sum(comp))
    while check:
      ...
      if sum(user) > 21:
        ...
        next_card = input('Do you want another card ? write yes or no : ')
...
result = calculate_score(cards = [11, 2, 3, 4, 5, 6, 7, 8, 9, 10, 10, 10, 10])
print(result)
